...
fo = open("./profile results/1stage.riscv.out", "r+")
...
while True:
    ...
    if index != -1 :
        #newline = line[index+3:index+14]
        print "Read Line: %s" % (assembly[line[index+4:index+14]])

        temp = count[types[assembly[line[index+4:index+14]]]] + 1
        count[types[assembly[line[index+4:index+14]]]] = temp
